...
export function AddCar() {
  ...
  const { control, handleSubmit, setValue, watch, formState: { isSubmitting, errors } } = useForm();
  ...
  return (
    <Container p={4}>
      <Stack space={4}>
        <FormControl
          isInvalid={
            Boolean(errors.make) || Boolean(validationErrors?.make)
          }
        >
          <Controller
            name="make"
        ...
        <FormControl
          isInvalid={
            Boolean(errors.model) || Boolean(validationErrors?.model)
          }
        >
          <Controller
            name="model"
        ...
        <FormControl
          isInvalid={
            Boolean(errors.year) || Boolean(validationErrors?.year)
          }
        >
          <Controller
            name="year"
        ...
        <FormControl
          isInvalid={
            Boolean(errors.color) || Boolean(validationErrors?.color)
          }
        >
          <Controller
            name="color"
