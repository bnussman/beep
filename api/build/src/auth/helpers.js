...
function getToken(user) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        yield app_1.BeepORM.tokenRepository.persistAndFlush(t);
        return {
            userid: user._id,
            tokenid: t.tokenid,
            token: t._id
 ...
 */
function setPushToken(user, token) {
    return __awaiter(this, void 0, void 0, function* () {
        if (!user)
            return;
...
function getUserFromEmail(email) {
    return __awaiter(this, void 0, void 0, function* () {
        const user = yield app_1.BeepORM.userRepository.findOne({ email: email });
        if (user) {
            return user;
        }
        return null;
 ...
 * @returns Promise<UserPluckResult>
 */
function getUserFromId(id, ...pluckItems) {
    return __awaiter(this, void 0, void 0, function* () {
        //TODO is id ok? or do i need to make it a ObjectId
        const user = yield app_1.BeepORM.userRepository.findOne(id, { fields: pluckItems });
        if (user) {
            return user;
        }
 ...
 * @returns void
 */
function deactivateTokens(user) {
    return __awaiter(this, void 0, void 0, function* () {
        yield app_1.BeepORM.tokenRepository.removeAndFlush({ user: user });
    });
}
 ...
 * @returns void
 */
function createVerifyEmailEntryAndSendEmail(user, email, first) {
    return __awaiter(this, void 0, void 0, function* () {
        if (!email || !first) {
        ...
        yield app_1.BeepORM.verifyEmailRepository.persistAndFlush(entry);
        //send the email
...
function doesUserExist(username) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const c = yield app_1.BeepORM.userRepository.count({ username: username });
            if (c >= 1) {
                return true;
            }
        }
