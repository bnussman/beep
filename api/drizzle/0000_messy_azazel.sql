...
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "beep_beeper_id_index" ON "beep" ("beeper_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "beep_rider_id_index" ON "beep" ("rider_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "beep_status_index" ON "beep" ("status");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "beep_beeper_id_rider_id_index" ON "beep" ("beeper_id","rider_id");--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "beep_start_index" ON "beep" ("start");--> statement-breakpoint
DO $$ BEGIN
...
--> statement-breakpoint
DO $$ BEGIN
 ALTER TABLE "token" ADD CONSTRAINT "token_entry_user_id_foreign" FOREIGN KEY ("user_id") REFERENCES "public"."user"("id") ON DELETE no action ON UPDATE cascade;
EXCEPTION
 WHEN duplicate_object THEN null;
END $$;
