...
function Terms() {
  return (
    <Stack spacing={2}>
      ...
      <Typography variant="subtitle1">Modified and Effective as of January 19, 2021</Typography>
      <Box>
        <Accordion>
          <AccordionSummary>
            The Company
        ...
        <Accordion>
          ...
          <AccordionDetails>
            <Stack spacing={1}>
              <Typography>The Terms of Use being utilized also known as "Terms" govern the Users connection or use, within the borders of the United States of America and its respective territories and holdings, of the applications, websites, content, products, and services made available within the borders of the United States of America and its respective territories and holdings by Ian &amp; Banks LLC and its owners and creators. The term &ldquo;Services&rdquo; will be more thoroughly defined below. Be certain to read the Terms provided thoroughly, as these Terms create a legal agreement between you and Beep.</Typography>
              <Typography>By utilizing the Services rendered by Beep, you agree to be bound by these Terms. If you do not agree with the Terms provided, you will not access or use the Services offered. These Terms fully overrule previous contractual relationships or arrangements with the User in respect to the use of the Services.</Typography>
              <Typography>Notwithstanding the foregoing, these Terms do not overrule or otherwise impact the enforceability of any agreements you may have with Beep or its subsidiaries regarding the use of the Services provided. To the extent (but only to the extent) any agreement you may have with Beep in regards to the Services provided conflicts with these Terms, the agreements created (and not the Terms outlined in this document) prevail.</Typography>
              <Typography>Beep has the right to immediately abolish these Terms or any Services with respect to you, or generally cease from offering or deny access to the Services or any portion thereof, at any time for any reason.</Typography>
              <Typography><b>Arbitration Notice</b>: It is to your benefit to thoroughly review the Arbitration Agreement outlined below, as the agreement will hold you to resolve disputes with Beep on an individual basis through final and binding arbitration. By agreeing to this, you clearly acknowledge that you have thoroughly read and understand all of the Terms provided within this agreement and have taken sufficient time to consider the consequences of this decision.</Typography>
              <Typography>Supplemental terms may apply to certain Services, such as policies for a particular event, program, activity or promotional advertisement, and such supplemental terms will be provided to you in separate region-specific disclosures (e.g., a particular city webpage on ridebeep.app) or in connection with the Service(s) that apply. Supplemental terms are in addition to, and shall be deemed a part of, the Terms for the purposes of the applicable Service(s). Supplemental terms shall prevail over these Terms in the possible event of a conflict with respect to the applicable Services.</Typography>
              <Typography>Beep has the right to amend or alter the Terms from time to time. Amendments will be made effective upon their release by Beep. The updated Terms will be provided at this location or within the amended policies or supplemental terms on the applicable Service(s). By continuing to access or utilize the Services after the posting of new or existing Terms confirms your agreement to be bound by the Terms, as written. If Beep alters these Terms following the date you initially agreed to be bound by them (or to any following changes to these Terms), you may reject any such alteration by providing written notice via email to ian@ridebeep.app. This written disagreement must be sent within 30 days of the amendment being made &ldquo;Effective&rdquo;. Within the notice you must include the full name of the person associated with the Account and clearly indicate that you are rejecting the changes to the Terms. In rejecting changes made, you are agreeing to be bound by the Terms as of the date you first agreed to the Terms (or to the date prior to your rejection of changes to the Terms).</Typography>
              <Typography>The collection and use of personal information in relation to the Services rendered by Beep is outlined in Beep&rsquo;s Privacy Statements located on our privacy page found <Link component={RouterLink} to="/privacy">here</Link>.</Typography>
            </Stack>
          </AccordionDetails>
        </Accordion>
        <Accordion>
        ...
        <Accordion>
          ...
          <AccordionDetails>
            <Typography>You agree to not hold Beep and its affiliates and their officers, directors, employees, and agents liable or responsible for any and all claims, demands, losses, liabilities, and expenses (including attorneys&rsquo; fees), as a result of or in connection with: your use of the Services or services or goods obtained through the use of the Services; your breach or violation of any of these Terms; Beep&rsquo;s use of your Use Content; or your violation of the rights of any third party, including Third Party Providers. &nbsp;</Typography>
          </AccordionDetails>
        </Accordion>
        <Accordion>
          <AccordionSummary>
