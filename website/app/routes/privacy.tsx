      ...
      <Typography fontSize='sm' margin={2}>
        <Box margin={3}>
          <ul>
            ...
            <li><b>Request feedback.</b> We may use your information to request feedback and to contact you about your use of our Services.</li>
            ...
            <li><b>Fulfill and manage your orders.</b> We may use your information to fulfill and manage your orders, payments, returns, and exchanges made through the Services.</li>
      ...
      <Typography fontSize='sm' margin={2}>
        <Box margin={3}>
          <ul>
            ...
            <li><b>Legitimate Interests:</b> We may process your data when it is reasonably
              necessary to achieve our legitimate business interests.</li>
            <li><b>Performance of a Contract:</b> Where we have entered into a contract with you,
              we may process your personal information to fulfill the terms of our contract.</li>
            <li><b>Legal Obligations:</b> We may disclose your information where we are legally
            ...
            <li><b>Vital Interests:</b> We may disclose your information where we believe
      ...
      <Box margin={3}>
        <Typography fontSize='sm' margin={2}>
          <ul>
            ...
            <li><b>Business Partners:</b> We may share your information with our
              business partners to offer you certain products, services or promotions.</li>
            <li><b>Other Users:</b> When you share personal information or otherwise
