...
const namespace = new k8s.core.v1.Namespace(namespaceName, { metadata: { name: namespaceName, labels: { name: namespaceName }}}, { provider: k8sProvider });
...
const config = new k8s.core.v1.ConfigMap(appName, {
  metadata: {
    name: appName,
...
const secret = new k8s.core.v1.Secret(appName, {
