...
exports.apiIp = exports.clusterLabel = void 0;
const pulumi = require("@pulumi/pulumi");
const linode = require("@pulumi/linode");
const docker = require("@pulumi/docker");
const k8s = require("@pulumi/kubernetes");
const selfSignedCert = require("@pulumi/tls-self-signed-cert");
...
const lkeCluster = new linode.LkeCluster("cluster", {
    region: "us-southeast",
    k8sVersion: "1.33",
    controlPlane: {
...
const apiDeployment = new k8s.apps.v1.Deployment(apiAppName, {
    metadata: {
        name: apiAppName,
...
const secret = new k8s.core.v1.Secret(apiAppName, {
...
const apiService = new k8s.core.v1.Service(apiAppName, {
    metadata: {
        name: apiAppName,
...
const config = new k8s.core.v1.ConfigMap(apiAppName, {
    metadata: {
        name: apiAppName,
        namespace: namespaceName,
    },
...
exports.clusterLabel = lkeCluster.label;
exports.apiIp = apiService.status.loadBalancer.apply((lb) => lb.ingress[0].ip || lb.ingress[0].hostname);
