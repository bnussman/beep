...
export class ReportsResolver {
  ...
  public async getReports(
    ...
    const [reports, count] = await ctx.em.findAndCount(
      Report,
      {},
      {
  ...
  public async updateReport(
    @Ctx() ctx: Context,
    @Arg("id") id: string,
    @Arg("input") input: UpdateReportInput,
  ): Promise<Report> {
    const report = await ctx.em.findOneOrFail(Report, id, {
      populate: ["reporter", "reported", "handledBy"],
    });
  ...
  public async getReport(
    ...
    return await ctx.em.findOneOrFail(Report, id, {
      populate: ["reporter", "reported", "beep", "handledBy"],
    });
  }
