...
export class CarResolver {
  ...
  public async createCar(
    ...
    const extention = photo.name.substring(
    ...
    await s3.write(objectKey, photo, { acl: "public-read" });
  ...
  public async deleteCar(
    ...
    if (car.default && count > 1) {
      throw new GraphQLError(
        "You must make another car default before you delete this one.",
      );
    }
